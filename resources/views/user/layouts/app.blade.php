                ...
                <header class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class = "userheader-content">
                        ...
                        <!-- {{-- 時間割・授業進捗・プロフィール設定への各種画面への遷移させるためのボタン --}} -->
                            <button class = "userheader-button" onclick = "location.href = '{{ route('user.show.curriculum') }}'">時間割</button>
                            <button class = "userheader-button" onclick = "location.href = '{{ route('user.show.progress') }}'">授業進捗</button>
                            <button class = "userheader-button" onclick = "location.href = '{{ route('user.show.profile') }}'">プロフィール設定</button>
